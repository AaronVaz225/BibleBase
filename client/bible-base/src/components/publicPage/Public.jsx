  ...
  return (
    <>
      <div className="relative min-h-screen">
        {/*Nav Bar */}
        <div className="relative bg-[#d9dcd6] flex py-7 justify-around border-b-2 z-10">
                ...
                <div className="flex flex-1 flex-col justify-between bg-[#d9dcd6] p-6 border-2">
                  <div className="flex-1">
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      ...
                      that's always at your fingertips. Whether you're at home,
                      on the go, or deep in study, you’ll never be without the
                      Word.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                ...
                <div className="flex flex-1 flex-col justify-between bg-[#d9dcd6] p-6 border-2">
                  <div className="flex-1">
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      Take your theological notes with you wherever life leads.
                      Be ready for meaningful conversations, spontaneous
                      questions, or quick study sessions with instant access to
                      your personal insights and our curated study notes—all in
                      one place.
                    </p>
                  </div>
                </div>
          ...
          <div className="max-w-screen-xl mx-auto">
            ...
            <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative">
              ...
              <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
                ...
                <p className="text-xl font-light italic text-gray-700">
                  "Having the Bible with me wherever I go really helps me stay
                  in the word!"
                </p>
                <div className="flex items-center justify-center space-x-2 mt-4">
                  <svg
              ...
              <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
                ...
                <p className="text-xl font-light italic text-gray-700">
                  "I use BibleBase to prepare my sermon notes, thanks
                  BibleBase!"
                </p>
                <div className="flex items-center justify-center space-x-2 mt-4">
                  <svg
